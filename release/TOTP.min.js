...
{this.key=key;this.error_mess="";this.otp=0;this.countDown=0;this.log=!1;if(typeof user===typeof undefined)user=defaultUser;this.user=user;this.update();var me=this;this.interval=setInterval(function(){var epoch=Math.round(new Date().getTime()/1000.0);me.countDown=30-(epoch%30);if(epoch%30==0)me.update();if(me.log)console.log('Update OTP in '+me.countDown+' seconds...')},1000)}
dec2hex(s)
...
var otp=(this.hex2dec(hmac.substr(offset*2,8))&this.hex2dec('7fffffff'))+'';otp=(otp).substr(otp.length-6,6);this.otp=otp;if(this.log)console.log('New OTP: '+this.otp);return!0}
getOTP()
{return this.otp}
getCountDown()
